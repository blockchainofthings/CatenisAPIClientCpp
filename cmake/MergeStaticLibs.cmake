...
function(merge_static_libs output_library)
    ...
    foreach(lib ${libs})
        ...
        # Exclude OpenSSL libraries since their type is always detected as UNKNOWN_LIBRARY
        if(NOT lib MATCHES "^OpenSSL::.+" AND NOT libtype STREQUAL "STATIC_LIBRARY")
            message(STATUS ">>>>>> Type of library '" ${lib} "': " ${libtype})
